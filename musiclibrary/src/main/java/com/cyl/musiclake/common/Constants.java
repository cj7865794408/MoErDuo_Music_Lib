...
//    public static final String NEW_BASE_URL = "https://api.p.ajia.cn/ParentServer/";
    ...
    public static final String QueryRadioList = "QueryRadioList"; //查询电台列表

    public static final String StudentAddAudioToFavorite = "StudentAddAudioToFavorite"; //查询电台列表

    public static final String StudentDeleteAudioFromFavorite = "StudentDeleteAudioFromFavorite"; //查询电台列表
    ...
    public static SpecailRadioBean.DataBean.RadiosBean radiosData;
}

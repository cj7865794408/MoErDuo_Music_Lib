...
public class MvDetailActivity extends BaseActivity<MvDetailPresenter> implements MvDetailContract.View, OnPreparedListener {
    ...
    @BindView(R2.id.singerView)
    View mSingerView;
    @BindView(R2.id.singerTv)
    TextView mTvSinger;

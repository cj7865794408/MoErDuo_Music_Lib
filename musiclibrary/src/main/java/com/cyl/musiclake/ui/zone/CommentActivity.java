...
public class CommentActivity extends BaseActivity {
    ...
    @BindView(R2.id.item_comment_num)
    TextView comment_num;
    @BindView(R2.id.item_love_num)
    TextView love_num;
    @BindView(R2.id.item_comment_time)
    TextView item_comment_time;
    @BindView(R2.id.send_comment)
    Button send_comment;
    @BindView(R2.id.item_love)
    Button item_love;

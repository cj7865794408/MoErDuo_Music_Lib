package com.cyl.musiclake.ui.music.local.adapter;//package com.cyl.musiclake.ui.music.local.adapter;
//
...
//
//                    PlayManager.play(getAdapterPosition(), musicInfos, albumID);
//

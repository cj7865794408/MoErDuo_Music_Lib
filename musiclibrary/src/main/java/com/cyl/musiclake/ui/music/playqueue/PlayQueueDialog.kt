...
class PlayQueueDialog : BottomSheetDialogFragment(), PlayQueueContract.View {
    ...
    private lateinit var guanbi_id: TextView
    ...
    override fun onStart() {
        ...
        params.height = MusicApp.getInstance().screenSize.y / 7 * 5
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        guanbi_id = view.findViewById(R.id.guanbi_id)
...
//            tvPlayMode.text = PlayQueueManager.getPlayMode() + "  共" + musicList.size + "首"
//        else
            tvPlayMode.text = PlayQueueManager.getPlayMode()
    }
